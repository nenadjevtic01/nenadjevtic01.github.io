...
function SkrolGore() {
    ...
    function prikazPojedinacnogProizvoda(niz){
        ...
        for(let i=0;i<niz.length;i++){
            if(niz[i].id==proizvodID){
                html+=`<div class="row s_product_inner">
				<div class="col-lg-6">
					<div>
					...
					<div class="s_product_text jedanProizvod">
						...
						html+=`<ul class="list">
                            ...
                            if(niz[i].availableSizes!=null){
                                ...
                                if(niz[i].gender==1){
                                    html+=`<a href="../img/Size guide for Men.png" target="_blank"><span>Size guide</span></a>`
                                }else{
                                    html+=`<a href="../img/Size guide for Women.png" target="_blank"><span>Size guide</span></a>`
                                }
                                html+=`</p>`
    ...
    function ispisKorpa(niz){
        let korpa=JSON.parse(localStorage.getItem("cart"));
        let suma=0;
        /* let html=`<div class="row pt-3 pb-3 prviRedKorpa">
        <div class="col-sm-3 col-lg-2"><h5 class="centar">ID<h5></div>
        <div class="col-sm-3 col-lg-4"><h5 class="centar">Product name</h5></div>
        <div class="col-sm-3 col-lg-2"><h5 class="centar">Quantity</h5></div>
        <div class="col-sm-3 col-lg-2"><h5 class="centar">Selected size</h5></div>
        <div class="col-sm-3 col-lg-2"><h5 class="centar">Total</h5></div>
    </div>`; */
    let html=``;
        if(korpa){
